package org.sopt.SeventhSeminar.config.resolver;
...
public class UserIdResolver implements HandlerMethodArgumentResolver {
    ...
    @Override
    public Object resolveArgument(@NotNull MethodParameter parameter, ModelAndViewContainer modelAndViewContainer, @NotNull NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
