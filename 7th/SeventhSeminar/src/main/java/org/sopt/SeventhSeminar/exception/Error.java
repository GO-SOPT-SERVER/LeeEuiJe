package org.sopt.SeventhSeminar.exception;
...
public enum Error {
    ...
    NOT_FOUND_SAVE_IMAGE_EXCEPTION(HttpStatus.NOT_FOUND, "존재하지 않는 이미지 파일입니다"),
    NOT_FOUND_IMAGE_EXCEPTION(HttpStatus.NOT_FOUND, "존재하지 않는 이미지 파일입니다"),
    /**
     * 409 CONFLICT
     */
